...
{
    public class BonsaiListing
    {
        public BonsaiListing(Bonsai bonsai)
        {
            Id = bonsai.Id; 
            ProductTitle = bonsai.ProductTitle;
            ProductPrice = bonsai.ProductPrice;
            ProductImage = bonsai.ProductImage;
        }
    ...
    public class BonsaiDescription:Bonsai
    {
        public BonsaiDescription(Bonsai bonsai)
        {
            Id = bonsai.Id;
            ProductTitle = bonsai.ProductTitle;
            ProductPrice = bonsai.ProductPrice;
            ProductImage = bonsai.ProductImage;
            ProductDescription = bonsai.ProductDescription;
            CheckoutOptions = bonsai.CheckoutOptions;
            var rand = new Random();
            Rating = rand.Next(20, 60) * .1m;
            if(Rating >= 0.5m)
            {
                Rating -= 0.1m;
            }
    ...
    public class Bonsai : IStoreType
    {
        ...
        public static List<Bonsai> Init()
        {
            return new List<Bonsai>()
            {
                ...
                new Bonsai(){
                    Id = 2,
                    ProductTitle= "Chinese Juniper Itagawa Large",
                ...
                new Bonsai(){
                    ...
                    CheckoutOptions= new List<string>() {"Tools",  "Care"}
                },
                new Bonsai(){
                    Id = 9,
                    ...
                    CheckoutOptions= new List<string>() {"Tools",}
                },
                new Bonsai(){
                    Id = 101,
                ...
                new Bonsai(){
                    ...
                    CheckoutOptions= new List<string>() {"Tools", "Soil",}
                },
                new Bonsai(){
                    Id = 105,
                    ...
                    CheckoutOptions= new List<string>() {"Soil", "Care"}
                },
                new Bonsai(){
                    Id = 106,
                    ProductTitle= "Syzygium (Brush Cherry) Bonsai",
                ...
                new Bonsai(){
                    ...
                    CheckoutOptions= new List<string>() {}
                },
                new Bonsai(){
                    Id = 10002,
